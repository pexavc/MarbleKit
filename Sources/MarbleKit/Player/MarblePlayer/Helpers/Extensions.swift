...
public extension MediaPlayerTrack {
    ...
    func dynamicRange(_ options: MarblePlayerOptions) -> DynamicRange {
    ...
    var colorSpace: CGColorSpace? {
        MarblePlayerOptions.colorSpace(ycbcrMatrix: yCbCrMatrix as CFString?, transferFunction: transferFunction as CFString?)
    }
}
...
public let MarblePlayerErrorDomain = "MarblePlayerErrorDomain"

public enum MarblePlayerErrorCode: Int {
    case unknown
    case formatCreate
...
extension MarblePlayerErrorCode: CustomStringConvertible {
    public var description: String {
        switch self {
        case .formatCreate:
...
extension NSError {
    convenience init(errorCode: MarblePlayerErrorCode, userInfo: [String: Any] = [:]) {
        var userInfo = userInfo
        userInfo[NSLocalizedDescriptionKey] = errorCode.description
        self.init(domain: MarblePlayerErrorDomain, code: errorCode.rawValue, userInfo: userInfo)
    }
}
