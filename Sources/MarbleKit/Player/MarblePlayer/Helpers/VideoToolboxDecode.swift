...
//  MarbleKit.Player
//
// https://github.com/kingslay/KSPlayer/blob/develop/Sources/KSPlayer/MEPlayer/VideoToolboxDecode.swift
...
class VideoToolboxDecode: DecodeProtocol {
    ...
    required convenience init(assetTrack: FFmpegAssetTrack, options: MarblePlayerOptions) {
    ...
    init(assetTrack: FFmpegAssetTrack, options: MarblePlayerOptions, session: DecompressionSession?) {
...
class DecompressionSession {
    ...
    init?(codecpar: AVCodecParameters, options: MarblePlayerOptions) {
