...
//
//  Based on: https://github.com/kingslay/KSPlayer/blob/develop/Sources/KSPlayer/Metal/BufferProtocol.swift
...
extension CGImage {
    func image() -> MarbleImage? {
        MarbleImage.init(cgImage: self)
    }

    func image(quality: CGFloat) -> MarbleImage? {
        ...
        autoreleasepool {
            ...
            return MarbleImage(data: mutableData as Data)
        }
    }
