...
class WatermarkKernel {
    ...
    func encode(commandBuffer : MTLCommandBuffer, inputTexture : MTLTexture, watermarkTexture : MTLTexture, outputTexture : MTLTexture, offset : Float) {
