...
class BokehKernel {
    ...
    init(context : MetalContext) {
        ...
        self.kernelFunction = KernelFunction(name: "BokehKernel", context: self.context)
    }
...
extension MarbleCatalog {
    func bokeh(context: MetalContext, threshold: Float) -> MetalFilter {
        return { image in
            autoreleasepool {
                ...
                context.kernels.filters.bokeh.encode(commandBuffer: commandBuffer,
                                                     inputTexture: image,
