...
public class TransformKernel {
    ...
    public func prepareTransformedTexture(
    ...
    public func encode(commandBuffer : MTLCommandBuffer, inputTexture : MTLTexture, outputTexture : MTLTexture, transform: CGAffineTransform) {
