...
class StarsKernel {
    ...
    init(context : MetalContext) {
        ...
        self.kernelFunction = KernelFunction(name: "StarsKernel", context: self.context)
    }
    ...
    func encode(commandBuffer : MTLCommandBuffer,
        ...
        memcpy(timeBuffer.contents(), &timeRef, thresholdBuffer.length)
...
extension MarbleCatalog {
    func stars(context: MetalContext,
                  threshold: Float,
        ...
        return { image in
            ...
            autoreleasepool {
                ...
                context.kernels.filters.stars.encode(
